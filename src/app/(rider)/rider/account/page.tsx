...
import { useValidateBankDetials } from "@/services/shops/mutation";
...
function AccountDetails() {
  ...
  const {
    mutate: createUserBank,
    isPending: creatingUserBank,
          ...
          <div className="w-full flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              <select
                ...
                disabled={
                  isLoadingBanks || validatingBankLoading || creatingUserBank
                }
              ...
              <div className="relative">
                <input
                  ...
                  maxLength={10}
                  disabled={validatingBankLoading || creatingUserBank}
                />
            ...
            <Button
              ...
              disabled={
                !accountVerified || creatingUserBank || validatingBankLoading
              }
            >
              {creatingUserBank ? "Submitting..." : "Submit"}
            </Button>
          </div>
