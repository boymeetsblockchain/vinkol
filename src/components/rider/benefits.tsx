const benefits = [
  "Get paid fast for every completed job.",
  "Anyone can earn, even without a vehicle.",
  "Work in a trusted, safe community.",
  "Take tasks near you, no long-distance stress.",
];
