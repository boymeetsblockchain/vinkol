...
export const PrivacyPolicyPage = ({ country }: { country: Country }) => {
  const { coverAmount, contact, legal } = contentFor(country);
          ...
          <section className="mb-8 border-b pb-6 border-gray-200">
            ...
            <div className="space-y-4">
              ...
              <PolicyPoint
                ...
                content={`You must be at least 18 years old and legally authorized to enter binding contracts in ${legal.contractJurisdiction} or your country of residence.`}
              />
              <PolicyPoint
                icon={<Globe className="w-5 h-5 text-cyan-500" />}
                title="1.4 Governing Law"
                content={`These terms are governed by ${legal.governingLaw}. Disputes shall be settled through ${legal.disputeResolution}.`}
              />
            </div>
          </section>
              ...
              <PolicyPoint
                ...
                content={
                  <>
                    ...
                    <ul className="list-disc list-inside ml-4 text-gray-700 space-y-1">
                      <li>
                        Must comply with all {legal.transportRegulations}.
                      </li>
                      <li>
              ...
              <PolicyPoint
                ...
                content={
                  <>
                    <ul className="list-disc list-inside text-gray-700 space-y-1">
                      <li>
                        Coverage limited to {coverAmount} per package unless
                        otherwise stated.
                      </li>
                      <li>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <ul className="space-y-2">
                <li className="flex items-center">
                  ...
                  ,
                  <a
                    href="mailto:customercare@vinkolgroup.com"
                    className="ml-2 text-blue-600 hover:underline"
                  >
                    customercare@vinkolgroup.com
                  </a>
                </li>
                <li className="flex items-center">
