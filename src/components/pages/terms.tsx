...
export const TermsPage = ({ country }: { country: Country }) => {
  const { legal } = contentFor(country);
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 md:p-12">
          ...
          <section className="border-b pb-6 mb-6 border-gray-200 text-gray-700">
            ...
            <p>
              ...
              excluding public holidays declared by{" "}
              {legal.publicHolidayAuthority}.
            </p>
            <br />
            <p>
          ...
          <section className="mb-8 border-b pb-6 border-gray-200">
            ...
            <div className="space-y-4 text-gray-700">
              <ul className="list-disc ml-4 gap-2">
                <li>
                  Each Party validly exists under {legal.lawOfTheLand} and has
            ...
            <div className="space-y-4 text-gray-700">
              <ul className="list-disc ml-4 gap-2">
                ...
                <li>
                  ...
                  breach of regulatory or safety standards under{" "}
                  {legal.lawOfTheLand}.
                </li>
                <li>
          ...
          <section className="mb-8 border-b pb-6 border-gray-200">
            ...
            <div className="space-y-4 text-gray-700">
              <ul className="list-disc ml-4 gap-2">
                <li>
                  Each Party shall comply with {legal.dataProtectionLaw}.
                </li>
                <li>
