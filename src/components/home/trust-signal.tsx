...
const trustSignals = (coverAmount: string) => [
  {
  ...
  {
    label: `Up to ${coverAmount} item protection`,
    detail: "Claims resolved within 72 hours, no arguments.",
  },
];

export const Trust = ({ country }: { country: Country }) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
        <div className="order-2 md:order-1">
          ...
          <ul className="space-y-5">
            {trustSignals(coverAmount).map((item, index) => (
